"use strict";
/*
Coppied all this code from: https://yihau.github.io/solana-web3-demo/tour/create-keypair.html
*/
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var keypair, feePayer, txhash, balance;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                keypair = web3_js_1.Keypair.generate();
                console.log("public key: ".concat(keypair.publicKey.toBase58()));
                console.log("private key(bs58): ".concat(bs58.encode(keypair.secretKey)));
                feePayer = web3_js_1.Keypair.fromSecretKey(keypair.secretKey);
                return [4 /*yield*/, connection.requestAirdrop(feePayer.publicKey, 2e9)];
            case 1:
                txhash = _a.sent();
                //Output the transaction id
                console.log("txhash: ".concat(txhash));
                //Wait till the transaction is confirmed before retrieving the balance
            ...
            case 3:
                balance = _a.sent();
                console.log("".concat(balance / web3_js_1.LAMPORTS_PER_SOL, " SOL"));
                return [2 /*return*/];
        }
    });
}); })();
